...
const HEADERS: Record<string, string[]> = {
  'Personal Expenses': ['Name', 'Amount', 'Amount Paid', 'Due Date', 'Category', 'Recurring', 'Notes', 'Logged By', 'Logged At', 'App ID'],
  'Business Expenses': ['Name', 'Amount', 'Amount Paid', 'Due Date', 'Category', 'Recurring', 'Notes', 'Logged By', 'Logged At', 'App ID'],
